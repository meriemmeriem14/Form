$(function() {
    ...
    $('#send').click(function(event) {
        ...
        if (index === 5) {
            ...
            $('#myModalTitle').text('Bienvenue ' + $("#prenom").val());
            $(`<p>Vous êtes nés le ${$('#datepicker').val()} et vous habitez</p>`).appendTo($('.modal-body'));
            $(`<a href="http://maps.google.com/maps?q=Paris"><img src="${img_link}"></a>`).appendTo($('.modal-body'));
